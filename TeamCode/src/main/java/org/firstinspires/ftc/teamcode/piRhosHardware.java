...
public class piRhosHardware {
    public DcMotor frontLeft, backLeft, frontRight, backRight, cascadeMotorRight, cascadeMotorLeft, slider, turntable;

    public TouchSensor touchRight, touchLeft;
    public DistanceSensor distanceLeft, distanceRight;
    public Servo bucket;
    public CRServo intakeServoRight, intakeServoLeft;
    ...
    public void initTeleOpIMU(HardwareMap hwMap) {
        ...
        colorSensorLeft = hwMap.colorSensor.get("color_left");
...
//        bucket = hwMap.servo.get("bucket");
        intakeServoRight = hwMap.crservo.get("intakeServoRight");
        intakeServoLeft = hwMap.crservo.get("intakeServoLeft");
